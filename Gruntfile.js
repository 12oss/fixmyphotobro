	...
	grunt.initConfig({
		...
		concat: {
			css: {
				...
				dest: '_gh_pages/dist/css/fixmyphotobro.css'
			},
			js: {
				options: {
					separator: ';',
				...
				src: ['_gh_pages/assets/js/jquery.min.js',
					...
					'_gh_pages/assets/js/polyfill.min.js',
					'_gh_pages/assets/js/site.js'
				],

				dest: '_gh_pages/dist/js/fixmyphotobro.js'
			}
		},
		cssmin: {
			css: {
				src: '_gh_pages/dist/css/fixmyphotobro.css',
				dest: '_gh_pages/dist/css/min/fixmyphotobro.min.css'
			}
		},
		uglify: {
			js: {
				src: '_gh_pages/dist/js/fixmyphotobro.js',
				dest: '_gh_pages/dist/js/min/fixmyphotobro.min.js'
			}
		},
		watch: {
			css: {
